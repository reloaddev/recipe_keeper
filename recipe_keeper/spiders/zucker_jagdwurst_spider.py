import scrapy
from recipe_keeper.util.utils import is_number, is_unit
from recipe_keeper.util.formatter import format_ingredient


class ZuckerJagdwurstSpider(scrapy.Spider):
    name = "zucker_jagdwurst"
    start_urls = [
        "https://www.zuckerjagdwurst.com/de/rezepte/cremiges-orzotto-mit-veganen-hackbaellchen-spinat",
        "https://www.zuckerjagdwurst.com/de/rezepte/veganer-schichtsalat",
    ]
